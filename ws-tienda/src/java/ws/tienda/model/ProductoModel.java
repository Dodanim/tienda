...
// la lista de resultados de una consulta de selección
    ...
    public ClienteEntity obtenerEntidad(String carnet) {
        EntityManager em = JpaUtil.getEntityManager();
        try {
//Recupero el objeto desde la BD a través del método find
            ClienteEntity estudiante = em.find(ClienteEntity.class,
                    carnet);
            em.close();
            return estudiante;
        } catch (Exception e) {
    ...
    public int insertarEntidad(ClienteEntity estudiante) {
        EntityManager em = JpaUtil.getEntityManager();
    ...
    public int modificarEstudiante(ClienteEntity estudiante) {
        EntityManager em = JpaUtil.getEntityManager();
        EntityTransaction tran = em.getTransaction();
        try {
            tran.begin();//Iniciando transacción
...
//Recuperando el objeto a eliminar
            ClienteEntity est = em.find(ClienteEntity.class, carnet);
            if (est != null) {
                EntityTransaction tran = em.getTransaction();
                tran.begin();//Iniciando transacción
